...
function render_image() {
    ...
    if (temp_points.length == 1) {
        ...
        view.draw_line(temp_points[0], temp_points[1], view.get_point_radius(0.5), "black")
    }
...
function on_touch_on_canvas(event) {
    ...
    if (mouse_mode == 0 && event.which == 3) {
        ...
        if (temp_points.length >= 3) {
            ...
            field.add_barrier(temp_points[0], temp_points[1], temp_points[2])
            temp_points = []
        }
