class FieldView {
    ...
    draw_place(place, is_last_place = false) {
        let arc_color = "yellow"
        if (is_last_place) {
            arc_color = "darkgoldenrod"
        }
        this.draw_point(place, this.get_point_radius(), arc_color, "yellow")
    ...
    draw_triangle(triangle) {
        this.context.beginPath()
        this.context.moveTo(triangle.point_1.x, triangle.point_1.y)
        this.context.lineTo(triangle.point_2.x, triangle.point_2.y)
        this.context.lineTo(triangle.point_3.x, triangle.point_3.y)
        this.context.lineTo(triangle.point_1.x, triangle.point_1.y)
    ...
    get_point_radius(k = 1) {
        return view.field.height * 0.005 * k
    }
